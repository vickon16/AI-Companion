...
const formSchema = z.object({
  ...
  instructions: z
    .string()
    .min(200, { message: "Instructions requires at least 200 characters" }),
  seed: z
    .string()
...
const CompanionForm = ({ categories, initialData }: CompanionFormProps) => {
  ...
  return (
    <section className="h-full p-4 space-y-2 max-w-3xl">
      <Form {...form}>
        <form
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem className="flex flex-col space-y-4">
                ...
                <FormControl>
                  <ClientOnly loader={<Skeleton className="w-48 h-48" />}>
                    <ImageUpload
                      disabled={isLoading}
                      value={field.value}
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem className="col-span-2 md:col-span-1">
                  ...
                  <FormDescription>
                    This is how your AI Companion would be named
                  </FormDescription>
                  <FormMessage />
                </FormItem>
              )}
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem className="col-span-2 md:col-span-1">
                  ...
                  <FormControl>
                    <Input
                      placeholder="Your Ai Description"
                      disabled={isLoading}
                      {...field}
                    />
                  </FormControl>
